...
client:stop(true)
	...
	if cmd == '<fail' then
		if arg == nil then
		message.channel:sendMessage(string.format("<@%s>, You are a very stupid creature, you know that? I dont even know why i put up with your bs, i may as well just fucking ignore everything you say. Yeah i should fucking do that... Wait thats too harsh isnt it? Right let me explainl; you're supposed to tag someone else with this command. Understand now? Good.", message.author.id))
		end
